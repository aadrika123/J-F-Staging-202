...
class OnBoardingConductorRoute {
    ...
    init(app, onBoardingConductorServices) {
        ...
        app
            .route(`${common_1.baseUrl}/getAllConductorsList`)
            .get((req, res) => onBoardingConductorServices.getAllConductorList(req, res, "021G"));
        app
            .route(`${common_1.baseUrl}/getConductorStatus`)
            .get((req, res) => onBoardingConductorServices.getConductorStatus(req, res, "021G"));
        app
            .route(`${common_1.baseUrl}/validate-aadhar`)
            .post((req, res) => onBoardingConductorServices.validate_aadhar(req, res, "021G"));
    }
}
